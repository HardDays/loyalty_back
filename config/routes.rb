...
Rails.application.routes.draw do
  ...
  namespace 'api' do
    namespace 'v1' do
      ...
      post 'clients/profile/vk', action: :update_vk, controller: 'clients'
      post 'clients/profile/telegram', action: :update_telegram, controller: 'clients'
      ...
      get 'vk/groups', action: :show_group, controller: 'vk'
      post 'vk/groups', action: :create_group, controller: 'vk'
      put 'vk/groups', action: :update_group, controller: 'vk'
