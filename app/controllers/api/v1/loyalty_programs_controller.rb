...
module Api
    module V1
      class LoyaltyProgramsController < ApplicationController
        ...
        def index
        #   @programs = @auth_user.creator.company.programs.order('created_at DESC')
        ...
        private
          ...
          def level_params
            params.permit(
              :level_type, :min_pirce, :begin_date, :end_date, 
              ...
              :acurual_on_points, :accrual_on_register, :register_points,
